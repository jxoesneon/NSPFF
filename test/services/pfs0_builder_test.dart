...
void main() {
  group('Pfs0Builder Tests', () {
    test('Builds a valid PFS0 container with multiple files', () {
      ...
      final strOffsetMain =
          view.getUint32(mainEntryOffset + 0x10, Endian.little);
      ...
      final strOffsetNpdm =
          view.getUint32(npdmEntryOffset + 0x10, Endian.little);

      // String table names
      final strTableOffset = 0x10 + files.length * 0x18;
      final strTable =
          pfs0.sublist(strTableOffset, strTableOffset + stringTableSize);
      final mainName =
          utf8.decode(strTable.sublist(strOffsetMain, strOffsetMain + 4));
      final npdmName =
          utf8.decode(strTable.sublist(strOffsetNpdm, strOffsetNpdm + 9));
      ...
      expect(pfs0.sublist(headerSize + 4, headerSize + 9),
          equals([5, 6, 7, 8, 9]));
    });
    ...
    test('buildSingle produces a valid single-file PFS0', () {
      ...
      final pfs0 =
          Pfs0Builder.buildSingle('Application_0500000000000001.cnmt', data);
